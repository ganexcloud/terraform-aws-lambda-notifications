...
| <a name="input_create"></a> [create](#input\_create) | (Required) Whether to create all resources | `bool` | `true` | no |
| <a name="input_create_sns_topic"></a> [create\_sns\_topic](#input\_create\_sns\_topic) | (Required) Whether to create new SNS topic | `bool` | `true` | no |
...
| <a name="input_lambda_description"></a> [lambda\_description](#input\_lambda\_description) | (Optional) The description of the Lambda function | `string` | `null` | no |
...
| <a name="input_lambda_function_name"></a> [lambda\_function\_name](#input\_lambda\_function\_name) | (Required) The name of the Lambda function to create | `string` | n/a | yes |
...
| <a name="input_lambda_role"></a> [lambda\_role](#input\_lambda\_role) | (Optional) IAM role attached to the Lambda Function.  If this is set then a role will not be created for you. | `string` | `""` | no |
